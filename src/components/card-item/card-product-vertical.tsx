...
const CardProductVertical = ({
  ...
  <div
    className="w-full h-full relative border border-[#E4E8EC] rounded-lg overflow-hidden flex flex-col justify-between"
    onClick={() =>
    ...
    role="button"
  >
    <ImageRatio src={getImgUrl(pathImg)} alt="image product" ratio={1} className="flex-none" />
    {salePercentage && (
